...
import SaveLendingAndBorrowing from './SaveLendingAndBorrowing';
...
export default compose(
  ...
  firestoreConnect((props) => {
    ...
    return [
      {
        collection: `users/${props.auth.uid}/lendingAndBorrowing`,
        storeAs: 'myCosts'
      },
      {
        collection: `users/${props.profile.partnerId}/lendingAndBorrowing`,
